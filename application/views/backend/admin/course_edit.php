                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xl-8">
                                        ...
                                        <div class="form-group row mb-3">
                                            <div class="offset-md-2 col-md-10">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="is_free_certificate" id="is_free_certificate" value="1" <?php if($course_details['is_free_certificate'] == 1) echo 'checked'; ?> onclick="toggleCertificateFields(this.id)">
                                                    <label class="custom-control-label" for="is_free_certificate"><?php echo get_phrase('check_if_certificate_is_free'); ?></label>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="paid-certificate-stuffs">
                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="certificate_price"><?php echo get_phrase('certificate_price').' ('.currency_code_and_symbol().')'; ?></label>
                                                <div class="col-md-10">
                                                    <input type="number" class="form-control" id="certificate_price" name = "certificate_price" placeholder="<?php echo get_phrase('enter_certificate_price'); ?>" value="<?php echo $course_details['certificate_price']; ?>" min="0">
                                                </div>
                                            </div>

                                            <div class="form-group row mb-3">
                                                <label class="col-md-2 col-form-label" for="when_to_pay_for_certificate"><?php echo get_phrase('when_to_pay_for_certificate'); ?></label>
                                                <div class="col-md-10">
                                                    <select class="form-control select2" data-toggle="select2" name="when_to_pay_for_certificate" id="when_to_pay_for_certificate">
                                                        <option value="during_course_purchase" <?php if($course_details['when_to_pay_for_certificate'] == "during_course_purchase") echo 'selected'; ?>><?php echo get_phrase('during_course_purchase'); ?></option>
                                                        <option value="after_lessons" <?php if($course_details['when_to_pay_for_certificate'] == "after_lessons") echo 'selected'; ?>><?php echo get_phrase('after_lessons'); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
