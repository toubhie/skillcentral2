                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-xl-8">
                                            ...
                                            <div class="form-group row mb-3">
                                                <div class="offset-md-2 col-md-10">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" name="is_free_certificate" id="is_free_certificate" value="1" onclick="toggleCertificateFields(this.id)">
                                            ...
                                            <div class="paid-certificate-stuffs">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="number" class="form-control" id="certificate_price" name = "certificate_price" placeholder="<?php echo get_phrase('enter_certificate_price'); ?>" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="when_to_pay_for_certificate" id="when_to_pay_for_certificate">
                                                            <option value="during_course_purchase"><?php echo get_phrase('during_course_purchase'); ?></option>
                                                            <option value="after_lessons"><?php echo get_phrase('after_lessons'); ?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
